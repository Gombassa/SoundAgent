    ...
    tasks: [
      {
        ...
        code: [
          ...
          "mkdir D:\\SoundLibrary",
          "mkdir \"D:\\SoundLibrary\\_inbox\"",
          "mkdir \"D:\\SoundLibrary\\_staging\"",
          "mkdir \"D:\\SoundLibrary\\_errors\"",
          "mkdir \"D:\\SoundLibrary\\field\"",
          "mkdir \"D:\\SoundLibrary\\sfx\"",
          "mkdir \"D:\\SoundLibrary\\music\"",
          "mkdir \"D:\\SoundLibrary\\broadcast\"",
          "mkdir \"D:\\SoundLibrary\\unclassified\"",
        ],
      },
      { label: "Add D:\\SoundLibrary as an Import Folder in Basehead", note: "NodeTree → Imports → Add Import Folder → D:\\SoundLibrary — this is where processed files land" },
      ...
      { label: "Test it: manually copy a WAV file into D:\\SoundLibrary\\field and rename it WTHR_test-file_48k24b.wav", note: "This mimics the exact format SoundAgent delivers — search 'WTHR' in Basehead to find it" },
